...
namespace SieuThiMini
{
    class DBConnect
    {
        ...
        public static SqlConnection Mycon
        {
            get { return DBConnect.mycon; }
            set { DBConnect.mycon = value; }
        }
        ...
        public static void them_dl1(string sql1)
        {
            ...
            {
                MessageBox.Show("Không thành công " + e);
            }
        ...
        public static void Themdangky(string select, String tk, String pass, String sql1)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        frm_dangNhap dt = new frm_dangNhap();
                        dt.Show();
                        frm_dangKy a = new frm_dangKy();
                        a.Close();
                    }
                    mycon.Close();
                }
        ...
        public static void ktratk(string tk, string newmk, string repass, string sql1, string sql2, string sql3)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string t = "Tài khoản này không tồn tại !,Bạn vui lòng kiểm tra lại ";
        ...
        public static void Xoa(string sql)
        {
            ...
            {
                MessageBox.Show("Tài khoản bạn sửa trùng với tài khoản đã có ! Vui lòng kiểm tra lại ");
            }
